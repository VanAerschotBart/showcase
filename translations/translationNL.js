var translationNL = [
    ...
    [
        "Hallo!",
        "Zoals u waarschijnlijk hier boven al gemerkt hebt, mijn naam is Van Aerschot Bart, en ik ben een recent afgestudeerde webdeveloper. Omdat mijn professionele carriére in deze sector nog in de startblokken staat, heeft u waarschijnlijk nog nooit van mij gehoord. Echter, hier is een kans om daar verandering in te brengen! Een korte introductie: ik ben 35 jaar oud, vader van een 8 jaar oude dochter (mijn trots en vreugde!), woonachtig te Oudsbergen, Limburg. Mijn hoofdtaal in het programmeren is PHP, maar ik heb ook een zwakke plek voor JavaScript.	Om eerlijk te zijn, ik geniet van zowat elk aspect in het uitbouwen van een website in zijn geheel, en wanneer mijn kennis over een programmeertaal te kort schiet, zie ik dat als een uitdaging en een kans om bij te leren! Ik beheers het meeste van wat ik nodig heb om een mooie, volledig werkende website te maken maar ik ben nog op zoek naar een bedrijf wat mij wilt helpen mijn vaardigheden op punt te stellen en te opwaarderen. Ten eerste zodat ik kan blijven groeien en verbeteren, en ten tweede, dat op een dag, ik degene ben die mijn nieuwe collega's kan helpen en bijleren om beter te worden dan ze ooit hadden durven dromen!",
